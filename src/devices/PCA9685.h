...
#define PCA9685_ADDRESS(A5, A4, A3, A2, A1, A0)                                                                        \
    ((0x40U | (A5 << 5U) | (A4 << 4U) | (A3 << 3U) | (A2 << 2U) | (A1 << 1U) | A0))
...
#define PCA9685_PWM_PERCENT_TO_COUNT(PERCENT) ((uint16_t)(PERCENT * PCA9685_PWM_MAX_VALUE))
...
#define PCA9685_SET_LED_FULL_ON(reg, value)                                                                            \
    {                                                                                                                  \
        BIT_CLEAR(reg, 4U);                                                                                            \
        BIT_SET_VALUE(reg, 4U, value);                                                                                 \
    }

#define PCA9685_SET_LED_FULL_OFF(reg, value)                                                                           \
    {                                                                                                                  \
        BIT_CLEAR(reg, 4U);                                                                                            \
        BIT_SET_VALUE(reg, 4U, value);                                                                                 \
    }

#define PCA9685_SET_LED_OFF(val)                                                                                       \
    {                                                                                                                  \
        val = 0x10U;                                                                                                   \
    }
