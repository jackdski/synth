...
bool SGTL5000_configure(void)
{
    ...
    {
        const uint16_t anaPowerData = ((1U << SGTL5000_DAC_MONO_POWER_POS) | (1U << SGTL5000_STARTUP_POWERUP_POS) | (1U << SGTL5000_ADC_MONO_POWERUP_POS) |
    ...
    {
        const uint16_t linRegData = ((1U << SGTL5000_VDDC_MAIN_ASSN_POS) | (1U << SGTL5000_VDDC_MAIN_OVRD_POS) | SGTL5000_D_PROGRAMMING_GET_VAL_FROM_MV(1000U));
    ...
    // CHIP_LINE_OUT_CTRL
    {
        const uint16_t lineOutData = ((SGTL5000_LINE_OUT_CURRENT_0_54_MA << SGTL5000_LINE_OUT_CURRENT_POS) | (SGTL5000_LO_ANALOG_VOLTAGE_MAX));
    ...
    // CHIP_SHORT_CTRL
    {
        const uint16_t shortCtrlData = ((SGTL5000_CHIP_SHORT_CTRL_LVLADJR_125MA << SGTL5000_CHIP_SHORT_CTRL_LVLADJR_POS) |
    ...
    // CHIP_ANA_CTRL
    {
        const uint16_t anaCtrlData =
            ((SGTL5000_MUTE_LINEOUT_MUTE_ENABLED) | (SGTL5000_EN_ZCD_HEADPHONE_ENABLED) | (SGTL5000_MUTE_HEADPHONE_OUTPUT_MUTE_ENABLED) |
             (SGTL5000_SELECT_ADC_INPUT_LINEIN << SGTL5000_SELECT_ADC_INPUT_POS) | (SGTL5000_EN_ZCD_ADC_ENABLED) | (SGTL5000_MUTE_ADC_MUTE_ENABLED));
...

    {
        const uint16_t digPowerData =
            ((1U << SGTL5000_DIG_POWER_ADC_POWERUP_POS) | (1U << SGTL5000_DIG_POWER_DAC_POWERUP_POS) | (1U << SGTL5000_DIG_POWER_DAP_POWERUP_POS) |
             (1U << SGTL5000_DIG_POWER_I2S_OUT_POWERUP_POS) | (1U << SGTL5000_DIG_POWER_I2S_IN_POWERUP_POS));
...

    {
        const uint16_t anaPowerData =
            ((1U << SGTL5000_DAC_MONO_POWER_POS) | (1U << SGTL5000_STARTUP_POWERUP_POS) | (1U << SGTL5000_ANALOG_VOLTAGE_POWERUP_POS) |
             (1U << SGTL5000_ADC_MONO_POWERUP_POS) | (1U << SGTL5000_REFTOP_POWERUP_POS) | (1U << SGTL5000_HEADPHONE_POWERUP_POS) |
             (1U << SGTL5000_DAC_POWERUP_POS) | (1U << SGTL5000_CAPLESS_HEADPHONE_POWERUP_POS) | (1U << SGTL5000_ADC_POWERUP_POS) |
             (1U << SGTL5000_LINEOUT_POWERUP_POS));
    ...
    {
        const uint16_t chipClkData = ((SGTL5000_RATE_MODE_SYS_FS << SGTL5000_CHIP_CLK_CTRL_RATE_MODE_POS) |  // rate mode
    ...
    {
        const uint16_t chipI2sConfigData =
            (SGTL5000_CHIP_I2S_CTRL_SCLKFREQ_32FS | SGTL5000_CHIP_I2S_CTRL_I2S_SLAVE | SGTL5000_CHIP_I2S_CTRL_SCLK_INV_RISING_EDGE |
             (SGTL5000_DATALENGTH_16_BITS << SGTL5000_CHIP_I2S_CTRL_DLEN_POS) | (SGTL5000_I2S_MODE_LEFT_JUSTIFIED << SGTL5000_CHIP_I2S_CTRL_I2S_MODE_POS));
...

    {
        const uint16_t adcDacCtrlConfigData =
            ...
            ((0U << SGTL5000_ADC_DAC_CTRL_DAC_MUTE_RIGHT_POS) | (0U << SGTL5000_ADC_DAC_CTRL_DAC_MUTE_LEFT_POS));  // enable volume ramp, disable DAC L+R mute

        initSuccessful &= SGTL5000_writeI2C(SGTL5000_CHIP_ADC_DAC_CTRL_REG, adcDacCtrlConfigData);
    }

    {
        const uint16_t dacVolConfigData = (SGTL5000_DAC_VOL_SET_RIGHT_VOLUME(SGTL5000_DAC_VOL_GET_DB_VALUE(-12.0f)) |
    ...
    // ANA_CTRL
    {
        const uint16_t anaCtrlConfigData =
            (SGTL5000_MUTE_LINEOUT_MUTE_ENABLED | SGTL5000_EN_ZCD_HEADPHONE_ENABLED | SGTL5000_EN_ZCD_ADC_ENABLED | SGTL5000_MUTE_ADC_MUTE_ENABLED);
