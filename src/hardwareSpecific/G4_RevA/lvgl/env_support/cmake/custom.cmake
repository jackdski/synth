...
if (BUILD_SHARED_LIBS)
  add_library(lvgl_G4 SHARED ${SOURCES})
else()
  add_library(lvgl_G4 STATIC ${SOURCES})
endif()

add_library(lvgl_G4::lvgl_G4 ALIAS lvgl_G4)
...
target_compile_definitions(
  lvgl_G4 PUBLIC $<$<BOOL:${LV_LVGL_H_INCLUDE_SIMPLE}>:LV_LVGL_H_INCLUDE_SIMPLE>
              $<$<BOOL:${LV_CONF_INCLUDE_SIMPLE}>:LV_CONF_INCLUDE_SIMPLE>)

# Include root and optional parent path of LV_CONF_PATH
target_include_directories(lvgl_G4 SYSTEM PUBLIC ${LVGL_ROOT_DIR} ${LV_CONF_DIR})
...
set_target_properties(
  lvgl_G4
  PROPERTIES OUTPUT_NAME lvgl_G4
